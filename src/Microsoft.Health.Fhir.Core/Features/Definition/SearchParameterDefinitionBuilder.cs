    ...
    internal static class SearchParameterDefinitionBuilder
    {
            ...
            IModelInfoProvider modelInfoProvider)
        {
            ...
            for (int entryIndex = 0; entryIndex < searchParameters.Count; entryIndex++)
            {
                ...
                try
                {
                    SearchParameterInfo searchParameterInfo = CreateSearchParameterInfo(searchParameter, uriDictionary);
            ...
            foreach (var searchParameterElement in searchParameters)
            {
                ...
                for (int baseElementIndex = 0; baseElementIndex < bases.Count; baseElementIndex++)
                {
                    ...
                    validatedSearchParameters.Add((baseResourceType, CreateSearchParameterInfo(searchParameter, uriDictionary)));
                }
            }
        ...
        private static SearchParameterInfo CreateSearchParameterInfo(SearchParameterWrapper searchParameter, IDictionary<Uri, SearchParameterInfo> uriDictionary)
        {
